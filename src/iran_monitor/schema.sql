-- SQLite schema for Iran–UAE Crisis Monitor storage layer (SSOT=A/B)
-- Generated: 2026-03-01 (Asia/Dubai)

PRAGMA foreign_keys = ON;

CREATE TABLE IF NOT EXISTS runs (
  run_id TEXT PRIMARY KEY,
  run_ts TEXT NOT NULL,              -- Asia/Dubai ISO 8601 string with offset
  threat_level TEXT NOT NULL,        -- LOW/MEDIUM/HIGH/CRITICAL
  score INTEGER NOT NULL,
  sentiment TEXT,
  summary_ad TEXT,
  summary_dxb TEXT,
  delta_json TEXT,                   -- JSON string: NEW/UPDATED/REMOVED
  flags_json TEXT,                   -- JSON string: ["DEGRADED","SOURCE_DOWN",...]
  evidence_json TEXT,                -- JSON string: {links:[], hash:""}
  notebook_url TEXT
);
...
CREATE TABLE IF NOT EXISTS outbox (
  ...
  file_path TEXT,                    -- outbox/YYYY-MM-DD/HH-00_channel.(md|json)
